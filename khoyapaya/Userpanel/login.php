        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-6 col-sm-offset-3 contact-main">
                    ...
                    <form class="registar-form" name="login-form" id="login-form" method="POST" action="index.php">
                            <div id="error"></div>
                        <label for="email">User name / Email address</label>
                        <input class="input mytest" type="text" placeholder="User name" name="khoyapaya_email"id="khoyapaya_email"><br>
                        <label for="Password">Password</label>
                        <input class="input mytest" type="Password" placeholder="Password" name="khoyapaya_pword" id="khoyapaya_pword">
                        <div class="registar-check">
                        <input id="remember-check" class="checkbox" type="checkbox" name="register_check">
                        <label for="remember-check">Remember me</label>
                        </div>
                        <input class="btn" type="submit" value="LOGIN" id="login_button" name="login_button" />
                    </form>
