  ...
  <!DOCTYPE html>
      ...
      <head>
        <script src="https://kit.fontawesome.com/1869fd21f6.js" crossorigin="anonymous"></script>
            ...
            <script type="text/javascript" src="Newpass.js"></script>
          ...
          <div class="container ">
              <div class="row">
                  <div class="col-md-4 col-md-offset-4 contact-main ">
                      <form class="registar-form" method="POST" id="newpass-form">
                        <div id="error">
                        </div>
                         <p class="text-center"><i class="fas fa-lock fa-5x "></i></p>                       
                          <label for="password">New Password</label>
                          <input class="input mytest" type="password" name="password" id="password">
                          
                        <br><label for="conf_pass">Confirm Password</label>
                          <input class="input mytest" type="password" name="conf_pass" id="conf_pass">
                           
                          <input class="btn btn-lg btn-primary btn-block" type="submit" value="Send" id="btn" name="btn" onClick="validatePassword();"/>
