  ...
  <!DOCTYPE html>
      ...
      <head>
           ...
           <script type="text/javascript" src="forgetpass.js"></script>
          ...
          <div class="container ">
              <div class="row">
                  <div class="col-md-4 col-md-offset-4 contact-main ">
                    ...
                    <p class="text-center">You can reset your password here.
                    Enter your EmailId or phone no. here to change your password</p>
                         
                          <label for="email">Phone / Email</label>
                          <input id="text" class="input" type="text" name="reset" id="reset" required>
                           <div id="error">
                            </div>
                          <p></p>
                         
                          <input class="btn btn-lg btn-primary btn-block" type="submit" value="Send" id="btn" name="btn"/>
