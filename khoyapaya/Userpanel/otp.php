  ...
  <!DOCTYPE html>
      ...
      <head>
           ...
           <script type="text/javascript" src="otpcheck.js"></script>
              ...
              <div class="row">
                  <div class="col-md-4 col-md-offset-4 contact-main ">
                    ...
                    <div id="error">
                      ...
                      <form class="registar-form" method="POST" id="otp-form" >
                         <p class="text-center"><i class="fas fa-lock fa-5x "></i></p>
                         
                    <p class="text-center">Never Share Your OTP to anyOne</p>
                         
                          <label for="email">Enter your OTP here</label>
                          <input id="text" class="input" type="password" name="otp" id="otp" required>
                           
                          <p></p>
                          <a href="#" style="color: blue;">resend</a>
                         
                          <input class="btn btn-lg btn-primary btn-block" type="submit" value="Verify " id="otp_button" name="otp_button"/>           
